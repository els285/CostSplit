...
Round2 = Transaction("Tennents2",payers={Martin:21.30},participants={Ethan,Pat,Bruce,James,Martin,Cat},doPerTransactionSplitwise=False)
Round3 = Transaction("Guinness",payers={Cat:25},participants={Ethan,Pat,Bruce,James,Martin,Cat},doPerTransactionSplitwise=False)
Round4 = Transaction("Guiness2",payers={Bruce:25},participants={Ethan,Pat,Bruce,James,Martin,Cat},doPerTransactionSplitwise=False)
Aperol = Transaction("Aperol",payers={Ethan:13},participants={Pat,Cat},doPerTransactionSplitwise=False)
